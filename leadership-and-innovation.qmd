...
**LIS 5937 - [Knowledge Management Improvement Plan](img/KM_group.pdf){target="_blank"}**

This group project focused on the knowledge sharing system within a public library system. Within the this project I was tasked with editing, the System and Inferface Design section, and formatting the budget and timeline elements.

------------------------------------------------------------------------

### I.b. Students demonstrate effective communication skills.

**LIS 5020 - [Roles of Managers in Information Organizations](img/manager_poster.png){target="_blank"}**
...
**LIS 6711 - [Understanding Metadata](understanding_metadata.pdf){target="_blank"}**
...
As an employee, I engaged with the community when I volunteered to manage and oversee a movie series over the summer. I collaborated with my branch manager to work out the dates, selected an array of newly released movies from [Swank's Public Libraries Movie Licensing website](https://www.swank.com/public-libraries/copyright/){target="_blank"}, and put together a promotional post to share on social media.
...
**LIS 6511 - [Community Needs Assessment](img/community_needs_assessment.pdf){target="_blank"}**
